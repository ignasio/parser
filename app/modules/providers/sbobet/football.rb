        ...
        def get_line(league,agent)
          ...
          unless data.nil?  
            count.times do |i|
              ...
              if data[2][0][1][0][3][i+1][1][0]==1
                puts "ah"
                puts "0, H1, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, H2, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
              elsif data[2][0][1][0][3][i+1][1][0]==7
                puts "fhah"
                puts "0, TO, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, TU, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
              elsif data[2][0][1][0][3][i+1][1][0]==8
                puts "1st"
                puts "0, 1, nil, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, x, nil, #{data[2][0][1][0][3][i+1][2][1]}"
                puts "0, 2, nil, #{data[2][0][1][0][3][i+1][2][2]}"
              elsif data[2][0][1][0][3][i+1][1][0]==9
                puts "fhou"
                puts "0, TO, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, TU, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
              elsif data[2][0][1][0][3][i+1][1][0]==3
                puts "totals"
                puts "0, TO, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, TU, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
              elsif data[2][0][1][0][3][i+1][1][0]==5
                puts "1x2"
                puts "0, 1, nil, #{data[2][0][1][0][3][i+1][2][0]}"
                puts "0, x, nil, #{data[2][0][1][0][3][i+1][2][1]}"
                puts "0, 2, nil, #{data[2][0][1][0][3][i+1][2][2]}"
