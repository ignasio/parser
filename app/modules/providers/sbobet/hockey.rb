          ...
          unless data.nil?  
            count.times do |i|
              ...
              when 1 then
                ...
                arr["Hockey"][league][teams].push([0,"F1",data[2][0][1][0][3][i+1][1][5],data[2][0][1][0][3][i+1][2][0]])
                arr["Hockey"][league][teams].push([0,"F2",data[2][0][1][0][3][i+1][1][5],data[2][0][1][0][3][i+1][2][1]])
              when 7 then
                #puts "fhah"
                #puts "0, F1, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                #puts "0, F2, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
              ...
              when 8 then
                ...
                arr["Hockey"][league][teams].push([0,"1",nil,data[2][0][1][0][3][i+1][2][0]])
                arr["Hockey"][league][teams].push([0,"X",nil,data[2][0][1][0][3][i+1][2][1]])
                arr["Hockey"][league][teams].push([0,"2",nil,data[2][0][1][0][3][i+1][2][2]])

              when 9 then
                #puts "fhou"
                #puts "0, TO, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                #puts "0, TU, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
                arr["Hockey"][league][teams].push([0,"TO",data[2][0][1][0][3][i+1][1][5],data[2][0][1][0][3][i+1][2][0]])
                arr["Hockey"][league][teams].push([0,"TU",data[2][0][1][0][3][i+1][1][5],data[2][0][1][0][3][i+1][2][1]])
              when 3 then
                #puts "totals"
                #puts "0, TO, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][0]}"
                #puts "0, TU, #{data[2][0][1][0][3][i+1][1][5]}, #{data[2][0][1][0][3][i+1][2][1]}"
